...
export default function GateCheckin() {
  ...
  async function checkin(requestedTicketId = ticketId, requestedPhone = phone) {
    ...
    try {
      ...
      else if (response.status === 409) { setResult("used"); setTicket(body.ticket || (body.usedAt ? { scannedAt: body.usedAt, usedAt: body.usedAt } : null)); setMessage(body.error || "Ticket is already used or unavailable"); }
